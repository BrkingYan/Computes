...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView fftCallTimeView;
    private TextView mixCallTimeView;
    ...
    private float fftCallTimeConsume;
    private float mixCallTimeConsume;
        ...
        public void handleMessage(Message msg) {
            switch(msg.what){
                ...
                case 1:
                    ...
                    Log.d(TAG,"fft time:" + fftTimeConsume);
                    fftTimeConsumeView.setText(fftTimeConsume + "us");
                    break;
                //Mix
                case 2:
                    mixTimeConsume = (double)msg.obj;
                    Log.d(TAG,"mix time:" + mixTimeConsume);
                    mixTimeConsumeView.setText(mixTimeConsume+"us");
                    break;
                //FFT Call
                case 3:
                    fftCallTimeConsume = (float)msg.obj;
                    fftCallTimeView.setText(fftCallTimeConsume + "ms");
                    break;
                //Mix Call
                case 4:
                    mixCallTimeConsume = (float)msg.obj;
                    mixCallTimeView.setText(mixCallTimeConsume + "ms");
                    break;
            }
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fftCallTimeView = findViewById(R.id.FFT_call_time_comsume);
        mixCallTimeView = findViewById(R.id.Mix_call_time_comsume);
    ...
    private void setClickListeners(){
        ...
        resetBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                fftCallTimeView.setText("");
                mixCallTimeView.setText("");
