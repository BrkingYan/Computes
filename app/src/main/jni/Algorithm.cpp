...
double fft_float(jfloat real[],jfloat img[],int N,int k,int inv)
{
    ...
    */
	...
	//int timeDuration2 = ((double)(endTime2 - startTime2))*1000000/LOOP_TIME_TWO/CLOCKS_PER_SEC;
	return timeDuration;
}
...
*/
  ...
  JNIEXPORT jdouble JNICALL Java_com_example_yy_computes_Algorithm_doubleArrayCall
    (JNIEnv *env, jclass clazz, jfloatArray arr)
    {
        jfloat* arrP = env->GetFloatArrayElements(arr,0);
        jdouble result = 0;
        env->ReleaseFloatArrayElements(arr,arrP,0);
        return result;
    }
  ...
  JNIEXPORT jdouble JNICALL Java_com_example_yy_computes_Algorithm_intArrayCall
    ...
    {
        jint* arrP = env->GetIntArrayElements(arr,0);
        jdouble result = 0;
